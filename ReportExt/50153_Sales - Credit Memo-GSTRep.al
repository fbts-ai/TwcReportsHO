report 50153 "Sales - Credit Memo-GST" //FBTS 170724
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportExt/SalesCreditMemo.rdl';
    Caption = 'Sales - Credit Memo-FBTS';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfoBankIFSC; CompanyInformation."Payment Routing No.")
                    {
                    }
                    ...
                    column(location; "Sales Cr.Memo Header"."Location Code")
                    { }//PT-FBTS
                    column(extdocNo; "Sales Cr.Memo Header"."Applies-to Doc. No.")
                    { }//PT-FBTS
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            DetailedGST.RESET;
                            DetailedGST.SETRANGE(DetailedGST."Document No.", "Sales Cr.Memo Line"."Document No.");//PT(FBTS)
                            DetailedGST.SetRange("Document Line No.", "Sales Cr.Memo Line"."Line No.");
                            DetailedGST.SetRange("No.", "Sales Cr.Memo Line"."No.");
    ...
    var
        ...
        DocCaption: Text;
        TotalText: Text[50];
        DetailedGST: Record "Detailed GST Ledger Entry"; //PT-FBTS
