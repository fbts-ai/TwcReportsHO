report 50132 "Posted Purch. - Receipt Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Layouts/PostedPurchReceiptExt.rdl';
    Caption = 'Posted Purch. - Receipt Ext';
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        begin
                            ...
                            IF ("GST Group Code" <> '') AND (StrLen(Format("GST Group Code")) <= 2) THEN
                                Evaluate(GstCode, "GST Group Code");
