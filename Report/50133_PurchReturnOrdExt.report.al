report 50133 "Purch Return Order Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.vscode/Layouts/PurchReturnOrdExt.rdl';
    Caption = 'Purch. Return Order Ext';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(LineAmnt; "Purchase Line"."Line Amount")
                        { }
                        column(GstGroupCode; "Purchase Line"."GST Group Code")
                        { }
                        column(TotalTax; TotalTax)
                        { }
                        column(AmountInclTax; "Purchase Line"."Amount Including VAT")
                        { }
                        ...
                        begin
                            ...
                            //Newly Added
                            IF "Purchase Line"."Return Reason Code" <> '' Then
                                IF ReturnReason.Get("Purchase Line"."Return Reason Code") Then;

                            "Purchase Line"."Line Amount" := "Purchase Line".Quantity * "Purchase Line"."Direct Unit Cost";

                            IF ("Purchase Line"."GST Group Code" <> '') AND (StrLen(Format("Purchase Line"."GST Group Code")) <= 2) THEN
                                Evaluate(GstCode, "Purchase Line"."GST Group Code");

                            TotalTax := ("Purchase Line"."Line Amount" * GstCode) / 100;

                            //Adding Gst to Total
                            "Purchase Line"."Amount Including VAT" := "Purchase Line"."Line Amount" + TotalTax;
                        end;
